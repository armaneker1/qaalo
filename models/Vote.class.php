 ...
 * @package entity
 */
class Vote extends Db2PhpEntityBase implements Db2PhpEntityModificationTracking {
	private static $CLASS_NAME='Vote';
	const SQL_IDENTIFIER_QUOTE='';
	const SQL_TABLE_NAME='vote';
	const SQL_INSERT='INSERT INTO vote (id,itemID,userID,rate,createdOn) VALUES (?,?,?,?,?)';
	const SQL_INSERT_AUTOINCREMENT='INSERT INTO vote (itemID,userID,rate,createdOn) VALUES (?,?,?,?)';
	const SQL_UPDATE='UPDATE vote SET id=?,itemID=?,userID=?,rate=?,createdOn=? WHERE id=?';
	const SQL_SELECT_PK='SELECT * FROM vote WHERE id=?';
	const SQL_DELETE_PK='DELETE FROM vote WHERE id=?';
	const FIELD_ID=639272607;
	const FIELD_ITEMID=-214359310;
	const FIELD_USERID=128271786;
	const FIELD_RATE=160920932;
	const FIELD_CREATEDON=-895420189;
	...
	private static $FIELD_TYPES=array(
		...
		self::FIELD_ITEMID=>array(Db2PhpEntity::JDBC_TYPE_INTEGER,10,0,false),
		self::FIELD_USERID=>array(Db2PhpEntity::JDBC_TYPE_INTEGER,10,0,false),
		self::FIELD_RATE=>array(Db2PhpEntity::JDBC_TYPE_TINYINT,3,0,false),
	 ...
	 * Query by Example.
	 *
	 * Match by attributes of passed example instance and return matched rows as an array of Vote instances
	 *
	 * @param PDO $db a PDO Database instance
	 * @param Vote $example an example instance defining the conditions. All non-null properties will be considered a constraint, null values will be ignored.
	 * @param boolean $and true if conditions should be and'ed, false if they should be or'ed
	 * @param array $sort array of DSC instances
	 * @return Vote[]
	 */
	public static function findByExample(PDO $db,Vote $example, $and=true, $sort=null) {
	 ...
	 *
	 * Will return matched rows as an array of Vote instances.
	 *
	 * @param PDO $db a PDO Database instance
	...
	/**
	 * Will execute the passed statement and return the result as an array of Vote instances
	 *
	...
	/**
	 * returns the result as an array of Vote instances without executing the passed statement
	 *
	 * @param PDOStatement $stmt
	 * @return Vote[]
	 */
	...
	/**
	 * Execute select query and return matched rows as an array of Vote instances.
	 *
	...
	public function toDOM() {
		return self::hashToDomDocument($this->toHash(), 'Vote');
	}

	/**
	 * get single Vote instance from a DOMElement
	 *
	...
	/**
	 * get all instances of Vote from the passed DOMDocument
	 *
	...
	public static function fromDOMDocument(DOMDocument $doc) {
		$instances=array();
		foreach ($doc->getElementsByTagName('Vote') as $node) {

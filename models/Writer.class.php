 ...
 * @package entity
 */
class Writer extends Db2PhpEntityBase implements Db2PhpEntityModificationTracking {
        
        public static function create() {
            return new Writer();
        }
    
	private static $CLASS_NAME='Writer';
	const SQL_IDENTIFIER_QUOTE='';
	const SQL_TABLE_NAME='writer';
	const SQL_INSERT='INSERT INTO writer (id,userID,topicID,createdOn) VALUES (?,?,?,?)';
	const SQL_INSERT_AUTOINCREMENT='INSERT INTO writer (userID,topicID,createdOn) VALUES (?,?,?)';
	const SQL_UPDATE='UPDATE writer SET id=?,userID=?,topicID=?,createdOn=? WHERE id=?';
	const SQL_SELECT_PK='SELECT * FROM writer WHERE id=?';
	const SQL_DELETE_PK='DELETE FROM writer WHERE id=?';
	const FIELD_ID=-1405494154;
	const FIELD_USERID=535287809;
	const FIELD_TOPICID=-1578051569;
	const FIELD_CREATEDON=-173755604;
	 ...
	 * Query by Example.
	 *
	 * Match by attributes of passed example instance and return matched rows as an array of Writer instances
	 *
	 * @param PDO $db a PDO Database instance
	 * @param Writer $example an example instance defining the conditions. All non-null properties will be considered a constraint, null values will be ignored.
	 * @param boolean $and true if conditions should be and'ed, false if they should be or'ed
	 * @param array $sort array of DSC instances
	 * @return Writer[]
	 */
	public static function findByExample(PDO $db,Writer $example, $and=true, $sort=null) {
	 ...
	 *
	 * Will return matched rows as an array of Writer instances.
	 *
	 * @param PDO $db a PDO Database instance
	...
	/**
	 * Will execute the passed statement and return the result as an array of Writer instances
	 *
	...
	/**
	 * returns the result as an array of Writer instances without executing the passed statement
	 *
	 * @param PDOStatement $stmt
	 * @return Writer[]
	 */
	...
	/**
	 * Execute select query and return matched rows as an array of Writer instances.
	 *
	...
	protected function bindValues(PDOStatement &$stmt) {
		...
		$stmt->bindValue(3,$this->getTopicID());
	...
	public function toDOM() {
		return self::hashToDomDocument($this->toHash(), 'Writer');
	}

	/**
	 * get single Writer instance from a DOMElement
	 *
	...
	/**
	 * get all instances of Writer from the passed DOMDocument
	 *
	...
	public static function fromDOMDocument(DOMDocument $doc) {
		$instances=array();
		foreach ($doc->getElementsByTagName('Writer') as $node) {

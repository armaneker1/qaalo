...
class Topic extends Db2PhpEntityBase implements Db2PhpEntityModificationTracking {
	...
	const SQL_INSERT='INSERT INTO topic (id,userID,title,createdOn,rate,url,inviteCode) VALUES (?,?,?,?,?,?,?)';
	const SQL_INSERT_AUTOINCREMENT='INSERT INTO topic (userID,title,createdOn,rate,url,inviteCode) VALUES (?,?,?,?,?,?)';
	const SQL_UPDATE='UPDATE topic SET id=?,userID=?,title=?,createdOn=?,rate=?,url=?,inviteCode=? WHERE id=?';
